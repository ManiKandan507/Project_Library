...
import { useCurrentTotalMembersHook, useExpiredTotalMemberHook, useLastMonthComparisonHook, useRecentNewMemberHook, useRecentRenewMemberHook } from '@/CorporateMembershipReportingV2/hooks/Home';
...
import { NewMemberChart } from '@/CorporateMembershipReportingV2/NewMemberChart';
import { ErrorBoundary, ErrorFallback } from '@/CorporateMembershipReportingV2/common/errorBoundary';
import { RenewMemberChart } from '@/CorporateMembershipReportingV2/RenewMemberChart';
import { addValuesInObj } from '@/CorporateMembershipReportingV2/SalesChartWidget/helper';
...
const SideMenu = (props) => {
    ...
    useEffect(() => {
        ...
        _map(_groupBy(recentNewMember, "JoinMonth"), (groupArr) => {
            let constructedData = _map(_groupBy(groupArr, "JoinMonth"), (monthArr,index) => {
                ...
                <div className="d-flex title">
                    ...
                    <span className="ml-2">
                        <Tooltip title={"Total count of contacts in membership groups that are in good standing as of today (ie. expiration date greater than today)"} placement="right">
                            <Information className='cursor-pointer' style={{ width: "0.9rem" }} />
                        </Tooltip>
                    </span>
                </div>
