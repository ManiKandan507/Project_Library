...
import CommonTable from '@/CorporateMembershipReportingV2/common/CommonTable';
...
const CommonFileViewTable = (props) => {
  ...
  return (
    <>
      {showModal && <Modal visible={showModal} title={title} onCancel={handleCancel} footer={null} width='80%'>
