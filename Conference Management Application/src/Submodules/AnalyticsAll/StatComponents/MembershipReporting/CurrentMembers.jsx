...
import { useCurrentMemberHook } from "@/MembershipReportingV2/hooks/Home";
import { useCurrentMemberDetails } from "@/MembershipReportingV2/hooks/Members";
...
export const CurrentMembers = (props) => {
    ...
    const memberColumn = [
        ...
        },
        {
            ...
            className: "text-left",
            render: (_, data) => {
                return <a onClick={()=>handleTableClick(data)}><div className= "text-left">{data.TotalCount}</div></a>
            },
...
=======
                        <MembersChart currentMembers={currentMembers} isvertical={activeTab === "vertical" && true} chartRef={chartReference} handleChartClick={handleChartClick} domEl={domEl} height={'400px'} />
