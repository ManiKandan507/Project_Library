...
const DateRangePicker = ({props}) => {
    ...
    const [showTimeGroupBy] = useState(props.config.dateTime.showTimeGroupBy ? true : false);
    const [timeGroupBy] = useState(props.config.dateTime.timeGroupBy);
    const [hasCompare] = useState(showByConfig ? props.config.compareMode : false);
    ...
    const [defaultDates, setDefaultDates] = useState(() => {
        if (showByConfig) {
          return [moment(props.config.dateTime.startDate,"DD/MM/YYYY"), moment(props.config.dateTime.endDate,"DD/MM/YYYY")];
        } else {
