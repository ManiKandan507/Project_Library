...
import { CURRENT_MEMBERS_SCREEN, EXPIRED_MEMBERS_SCREEN, NEW_MEMBERS_SCREEN, RENEWING_MEMBERS_SCREEN, SALES_ACTIVITY_SCREEN, TREND_SCREEN } from "../../constants";
...
const fetchExtendedHistory = async (context) => {
  return await ReportingAPIs.getExtendedHistoryInfo(context.payload);
};
...
const matchedScreenApi = async (context) => {
  ...
  } else if (context.payload.screen === TREND_SCREEN || context.payload.screen === SALES_ACTIVITY_SCREEN) {
